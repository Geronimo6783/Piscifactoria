...
public class SalmonChinook extends Pez implements Carnivoro {
    ...
    public void showStatus(){
        ...
        System.out.println("Adulto: " + ((edad > AlmacenPropiedades.SALMON_CHINOOK.getMadurez()) ? "H" : "M"));
    ...
    public void grow(){
        if(vivo){
            ...
            if(vivo){
                edad++;
                if(edad == AlmacenPropiedades.SALMON_CHINOOK.getMadurez() || diasSinReproducirse >= AlmacenPropiedades.SALMON_CHINOOK.getCiclo()) {
                    fertil = true;
                }
            }
        }
