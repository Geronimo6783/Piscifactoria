...
public class Tanque {
     ...
     * @param capacidadMaximaPeces Capacidad máxima de peces que puede tener el tanque a establecer.
     */
     ...
     * @param capacidadMaximaComida Capacidad máxima de comida por tipo a establecer.
     */
    ...
    public void showCapacity(String piscifactoria){
        System.out.println("Tanque " + numeroTanque + " de la piscifactoría " + piscifactoria + " al " + String.format("%.2f", ((float)peces.size()/(float)capacidadMaximaPeces)) + "% de capacidad.");
    }

    public void alimentar(){
        int comidadNecesaria = 0;
        ...
        for(Integer cantidadComida : cantidadDeComidadNecesariaPorPez){
            comidadNecesaria += cantidadComida;
        }
        ...
        if(peces.get(0) instanceof Carnivoro){
            ...
            if(peces.get(0) instanceof Filtrador){
                ...
                if((comidaVegetal + comidaAnimal) >= comidadNecesaria){
    ...
    private void alimentarAleatorio(ArrayList<Integer> cantidadDeComidadNecesariaPorPez, int comidadNecesaria){
        Random rt = new Random();
        ArrayList<Integer> posicionesPecesAlimentados = new ArrayList<>();

        for(int i = 0; i < cantidadDeComidadNecesariaPorPez.size(); i++){
            if(cantidadDeComidadNecesariaPorPez.get(i) == 0){
