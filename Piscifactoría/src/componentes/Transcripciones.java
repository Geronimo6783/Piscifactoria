...
/**
 * Clase con utilidades para la creación de transcripciones de una partida del
 * sistema.
 */
public class Transcripciones {
     ...
     * 
     * @param archivoTranscripciones Archivo donde se realizarán las
     *                               transcripciones.
     */
     ...
     * @param piscifactoriaInicial Piscifactoría inicial con la que se inicia la
     *                             simulación.
     */
    public void iniciarTranscripciones(String nombrePartida, int dinero, String[] pecesRio, String[] pecesMar,
            String piscifactoriaInicial) {
        BufferedWriter buferEscritura = null;

        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones), "UTF-8"));
     ...
     */
    public void iniciarTranscripciones(String nombrePartida, int dinero, String[] pecesRio, String[] pecesMar,
            String[] extras, String piscifactoriaInicial) {
        BufferedWriter buferEscritura = null;
    ...
    public void registrarCompraComida(int cantidadComida, String tipoComida, int monedas, String piscifactoria) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + cantidadComida + " de comida de tipo " + tipoComida + "comprada por " + monedas
                    + ". Se almacena en la piscifactoría " + piscifactoria + ".");
            buferEscritura.flush();
        } catch (IOException e) {
    ...
    public void registrarCompraComida(int cantidadComida, String tipoComida, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + cantidadComida + " de comida de tipo " + tipoComida + "comprada por " + monedas
                    + ". Se almacena en el almacén central.");
            buferEscritura.flush();
        } catch (IOException e) {
            System.out.println("Hubo un problema al registrar la compra de la comida.");
        } finally {
    ...
    public void registrarCompraPeces(String pez, boolean sexo, int monedas, int tanque, String piscifactoria) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + pez + " " + ((sexo) ? "H" : "M") + " comprado por " + monedas
                    + " monedas. Añadido al tanque " + tanque + " de la piscifacotría " + piscifactoria + ".");
            buferEscritura.flush();
        } catch (IOException e) {
    ...
    public void registrarVentaPeces(int pecesVendidos, String piscifactoria, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + "Vendidos " + pecesVendidos + " peces de la piscifactoría " + piscifactoria
                    + " de forma manual por " + monedas + " monedas.");
            buferEscritura.flush();
        } catch (IOException e) {
     ...
     * @param piscifactoria Piscifactoría a la que pertenece el tanque que se ha
     *                      limpiado.
     */
     ...
     * 
     * @param tipo          Tipo de la piscifactoría si es 0 es de río y si es 1 es
     *                      de mar.
    ...
    public void resgistrarCompraPiscifactoria(int tipo, String piscifactoria, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + "Comprada la piscifactoría de " + ((tipo == 0) ? "río " : "mar ")
                    + piscifactoria + "por " + monedas + " monedas.");
            buferEscritura.flush();
        } catch (IOException e) {
    ...
    public void registrarCompraTanque(int numeroTanque, String piscifactoria, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + "Comprado un tanque número " + numeroTanque + " de la piscifactoría "
                    + piscifactoria + " por " + monedas + "monedas.");
            buferEscritura.flush();
        } catch (IOException e) {
    ...
    public void registrarCompraTanqueCria(int numeroTanque, String piscifactoria, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + "Comprado un tanque de cría número " + numeroTanque + " de la piscifactoría "
                    + piscifactoria + " por " + monedas + "monedas.");
            buferEscritura.flush();
        } catch (IOException e) {
            System.out.println("Hubo un problema a la hora de registrar la compra del tanque.");
    ...
    public void registrarCompraTanqueHuevos(int numeroTanque, String piscifactoria, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + "Comprado un tanque de huevos número " + numeroTanque + " de la piscifactoría "
                    + piscifactoria + " por " + monedas + "monedas.");
            buferEscritura.flush();
        } catch (IOException e) {
            System.out.println("Hubo un problema a la hora de registrar la compra del tanque.");
    ...
    public void registrarMejoraPiscifactoria(String piscifactoria, int nuevaCapacidad, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura.append("\n" + "Mejorada la piscifactoría " + piscifactoria
                    + " aumentando su capacidad de comida hasta un total de " + nuevaCapacidad + " por " + monedas
                    + " monedas.");
            buferEscritura.flush();
        } catch (IOException e) {
    ...
    public void registrarMejoraAlmacenCentral(int nuevaCapacidad, int monedas) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true), "UTF-8"));
            buferEscritura
                    .append("\n" + "Mejorado el almacén central aumentando su capacidad de comida hasta un total de "
                            + nuevaCapacidad + " por " + monedas + " monedas.");
            buferEscritura.flush();
        } catch (IOException e) {
     ...
     * @param pecesDeRio    Peces de río que hay en la simulación después de pasar
     *                      el día.
     * @param pecesDeMar    Peces de mar que hay en la simulación después de pasar
     *                      el día.
     ...
     * 
     * @param piscifactoria Piscifactoría a la que se añadieron los peces mediante
     *                      la opción oculta.
     */
    public void registrarAnadirPecesOculto(String piscifactoria) {
        ...
        try {
            ...
            System.out
                    .println("Hubo un problema a la hora de registrar la adición de peces mediante la opción oculta.");
        } finally {
            if (buferEscritura != null) {
                try {
                    buferEscritura.close();
     ...
     * 
     * @param monedasActuales Monedas de las que se dispone tras el añadido de
     *                        monedas.
     */
    public void registrarAnadirMonedasOculta(int monedasActuales) {
        ...
        try {
            ...
            System.out.println(
                    "Hubo un problema a la hora de registrar el añadido de monedas mediante la opción oculta.");
        } finally {
            if (buferEscritura != null) {
                try {
                    buferEscritura.close();
    ...
    public void registrarGeneracionPedido(int idPedido, String nombrePez) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true)));
    ...
    /**
     * Registra el envío parcial de peces en un pedido en el archivo de
     * transcripciones.
     *
     * @param idPedido      Identificador único del pedido en el que se enviaron
     *                      peces.
    ...
    public void registrarEnvioPeces(int idPedido, String nombrePez, int pecesEnviados) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true)));
            buferEscritura.append("\n" + " Enviados " + pecesEnviados + " peces al pedido de " + nombrePez
    ...
    /**
     * Registra el envío de peces criados en el tanque de cría
     * de una piscifactoría especificada.
     *
     * @param pecesEnviados Número de peces que se han enviado al tanque de cría.
     * @param piscifactoria El nombre de la piscifactoría a la que pertenece el
     *                      tanque de cría.
     */
    public void registrarEnvioPecesTanqueCria(int pecesEnviados, String piscifactoria) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true)));
            buferEscritura.append("\n" + pecesEnviados + " peces criados en el tanque de cría de la piscifactoría "
                    + piscifactoria + ".");
            buferEscritura.flush();
        } catch (IOException e) {
            System.out.println("Hubo un problema a la hora de registrar el pedido completado.");
    ...
    /**
     * Registra el envío de peces desde los tanques de huevos
     * a los tanques de cría de una piscifactoría especificada.
     *
     * @param pecesEnviados Número de peces que se han transferido desde los tanques
     *                      de huevos.
     * @param piscifactoria El nombre de la piscifactoría desde la que se han
     *                      transferido los peces.
     */
    public void registrarEnvioPecesTanqueHuevos(int pecesEnviados, String piscifactoria) {
        ...
        try {
            buferEscritura = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream(archivoTranscripciones, true)));
            buferEscritura.append("\n" + pecesEnviados + " peces transferidos a los tanques de la piscifactoría "
                    + piscifactoria + "desde sus tanques de huevos.");
            buferEscritura.flush();
        } catch (IOException e) {
            System.out.println("Hubo un problema a la hora de registrar el pedido completado.");
        } finally {
